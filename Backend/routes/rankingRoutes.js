...
const {postRankingApproval, getUserSubmissions, userApprovalDelete , assignEventRanking, declineRanking , getRegisteredUsersAndRankings , getAllUsersRanking} = require('../controllers/ranking');
