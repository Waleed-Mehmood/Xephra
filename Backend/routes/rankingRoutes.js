...
const {postRankingApproval, getUserSubmissions, userApprovalDelete , assignEventRanking, declineRanking , getRegisteredUsersAndRankings , getAllUsersRanking , getTopRanking} = require('../controllers/ranking');
