  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('https://thumbs.dreamstime.com/b/teenage-girl-wearing-headset-gaming-home-using-dual-computer-screens-teenage-girl-wearing-headset-gaming-home-using-dual-166580706.jpg')",
        }}
      >
        <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-center text-white">
          <h1 className="text-2xl lg:text-4xl md:text-3xl sm:text-2xl font-bold">Welcome, Admin!</h1>
          <p className="mt-2 md:text-lg sm:text-base">Manage and monitor all the gaming events and rankings efficiently.</p>
        </div>
      </div>

      {/* Analytics & Stats Dashboard Section */}
      <div className="bg-[#F7E8E8] p-4 mt-8 rounded shadow">
        <h2 className="lg:text-2xl md:text-xl sm:text-lg font-bold mb-4">Analytics & Stats</h2>
      ...
      <div className="grid grid-cols-12 gap-6 mt-8">
        ...
        <div className="col-span-12 lg:col-span-9 bg-[#F7E8E8] p-4 rounded shadow">
          <h2 className="lg:text-2xl md:text-xl sm:text-lg font-bold mb-4">Posted Events</h2>
          <Slider {...settings}>
            {events.map((event) => (
      ...
      <div className="bg-[#F7E8E8] p-4 mt-8 rounded shadow">
        <h2 className="lg:text-2xl md:text-xl sm:text-lg font-bold mb-4">Manage Users</h2>
      ...
      <div className="bg-[#F7E8E8] p-4 mt-8 rounded shadow">
        <h2 className="lg:text-2xl md:text-xl sm:text-lg font-bold mb-4">Global Leaderboard</h2>
        <ul>
